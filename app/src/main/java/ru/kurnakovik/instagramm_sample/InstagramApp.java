...
public class InstagramApp {
    ...
    private String IMAGES_URL = API_URL+"/tags/"+mTag+"/media/recent";
		...
		new Thread() {
			...
			public void run() {
				...
				try {
					...
					Log.i(TAG, "Before stream writer");
    ...
    public ArrayList<ImageURL> getImages(){
        ...
        try {
            Log.i(TAG, "Getting images for tag:"+mTag+"URL:"+ IMAGES_URL);
            IMAGES_URL = API_URL+"/tags/"+mTag+"/media/recent";
            Log.i(TAG, "Second attempt. Getting images for tag:"+mTag+" URL:"+ IMAGES_URL);
